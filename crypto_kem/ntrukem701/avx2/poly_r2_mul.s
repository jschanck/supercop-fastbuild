...
vpand mask0011, %ymm5, %ymm5
vpand mask0110, %ymm14, %ymm14
vpand mask1100, %ymm15, %ymm15
...
vpand mask0011, %ymm5, %ymm5
vpand mask0110, %ymm13, %ymm13
vpand mask1100, %ymm14, %ymm14
...
vpand mask0011, %ymm13, %ymm13
vpand mask0110, %ymm6, %ymm6
vpand mask1100, %ymm7, %ymm7
...
vpand mask0011, %ymm13, %ymm13
vpand mask0110, %ymm1, %ymm1
vpand mask1100, %ymm4, %ymm4
...
vpand mask1100, %ymm8, %ymm13
vpand mask0011, %ymm3, %ymm12
vpxor %ymm12, %ymm13, %ymm12
vpsrlq $61, %ymm12, %ymm12
vpermq $78, %ymm12, %ymm12
vpxor %ymm12, %ymm2, %ymm2
vpand mask1000, %ymm8, %ymm12
vpand mask0001, %ymm3, %ymm13
vpxor %ymm12, %ymm13, %ymm12
vpsllq $3, %ymm12, %ymm12
vpermq $147, %ymm12, %ymm12
vpxor %ymm12, %ymm2, %ymm2
vpand mask1100, %ymm3, %ymm13
vpand mask0011, %ymm1, %ymm12
vpxor %ymm12, %ymm13, %ymm12
vpsrlq $61, %ymm12, %ymm12
vpermq $78, %ymm12, %ymm12
vpxor %ymm12, %ymm0, %ymm0
vpand mask1000, %ymm3, %ymm12
vpand mask0001, %ymm1, %ymm13
vpxor %ymm12, %ymm13, %ymm12
vpsllq $3, %ymm12, %ymm12
vpermq $147, %ymm12, %ymm12
vpxor %ymm12, %ymm0, %ymm0
vpand mask1100, %ymm1, %ymm13
vpand mask0011, %ymm4, %ymm12
vpxor %ymm12, %ymm13, %ymm12
vpsrlq $61, %ymm12, %ymm12
vpermq $78, %ymm12, %ymm12
vpxor %ymm12, %ymm8, %ymm8
vpand mask1000, %ymm1, %ymm12
vpand mask0001, %ymm4, %ymm13
vpxor %ymm12, %ymm13, %ymm12
vpsllq $3, %ymm12, %ymm12
vpermq $147, %ymm12, %ymm12
vpxor %ymm12, %ymm8, %ymm8
vpand low189, %ymm8, %ymm8
vmovdqa %ymm2, 0(%rdi)
vmovdqa %ymm0, 32(%rdi)
vmovdqa %ymm8, 64(%rdi)
ret
