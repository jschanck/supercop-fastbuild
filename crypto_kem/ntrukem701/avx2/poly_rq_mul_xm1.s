...
.byte 255
.text
.global poly_Rq_mul_xm1
.att_syntax prefix
poly_Rq_mul_xm1:
vmovdqu 1374(%rsi), %ymm0
vpsubw 1376(%rsi), %ymm0, %ymm1
vpand mask_mod8192, %ymm1, %ymm1
vmovdqa %ymm1, 1376(%rdi)
vextracti128 $1, %ymm0, %xmm4
vpshufb shuf_5_to_0_zerorest, %ymm4, %ymm4
vpsubw 0(%rsi), %ymm4, %ymm4
vpand mask_mod8192_only_lowest, %ymm4, %ymm4
...
vpand mask_mod8192_omit_lowest, %ymm3, %ymm3
